...
internal object HindiLocalization : Localization {
    ...
    override val onboardingMainText = "Llamatik एक निजी, ऑन-डिवाइस AI सहायक है, जो आपको चैट करने, विचारों को समझने और काम पूरे करने में मदद करता है — बिना क्लाउड पर निर्भर हुए।\n" +
            "\n" +
            "सभी कार्य आपके डिवाइस पर ही होते हैं, जिससे आपको अपने डेटा पर पूरा नियंत्रण मिलता है और दूरस्थ सर्वरों की ऊर्जा खपत कम होती है।\n" +
            "\n" +
            "अधिक जानकारी के लिए llamatik.com पर जाएं" +
            "\n" +
            "\n" +
            "\uD83D\uDD10 गोपनीयता सूचना\n\n" +
            "आपकी गोपनीयता पूरी तरह सुरक्षित है। यह ऐप पूरी तरह आपके डिवाइस पर चलता है।\n" +
            "कोई भी व्यक्तिगत डेटा एकत्र, संग्रहीत या साझा नहीं किया जाता।\n" +
            "कोई जानकारी बाहरी सर्वरों को नहीं भेजी जाती।\n" +
            "\n" +
            "---\n" +
            "\n" +
            "जारी रखने पर आप स्वीकार करते हैं कि Llamatik एक स्थानीय AI सहायक के रूप में प्रदान किया गया है और GDPR, CCPA और LGPD जैसे वैश्विक गोपनीयता नियमों का पालन करता है।\n" +
            "\n"
    ...
    override val textGeneration = "टेक्स्ट जनरेशन"
    override val embeddingModelNotLoaded = "कोई एम्बेडिंग मॉडल लोड नहीं है"
    override val noEmbeddingModelLoaded = "एम्बेडिंग मॉडल लोड नहीं है"
    override val recommended = "अनुशंसित"
    override val pdfSelectFile = "कृपया एक PDF फ़ाइल चुनें।"
    override val pdfExtractionError = "इस PDF से टेक्स्ट निकाला नहीं जा सका। यदि यह स्कैन की हुई PDF है, तो OCR की आवश्यकता है।"
    override val pdfEmbedModelNeededWarning = "PDF RAG उपयोग करने के लिए कृपया एम्बेडिंग मॉडल डाउनलोड/लोड करें: \"nomic-embed-text\" (Embed Models)।"
    override val pdfNoUsableChunksError = "इस PDF से कोई उपयोगी टेक्स्ट भाग उत्पन्न नहीं हुआ।"
    override val pdfFailedToComputeEmbeddingsError = "इस PDF के लिए एम्बेडिंग की गणना विफल रही। कृपया एम्बेडिंग मॉडल पुनः लोड करें और फिर से प्रयास करें।"
    override val pdfIndexedForRAG = "✅ PDF को RAG के लिए इंडेक्स किया गया"
    override val pdfFailedToLoadPDFForRAG = "RAG के लिए PDF लोड करने में विफल"
    override val failedToComputeEmbeddings = "आपके प्रश्न के लिए एम्बेडिंग की गणना विफल रही। कृपया एम्बेडिंग मॉडल पुनः लोड करें और फिर से प्रयास करें।"
    ...
    override val removeAllDownloadedModels = "सभी डाउनलोड किए गए मॉडल और PDF RAG इंडेक्स हटाएँ"
    override val clearCachedModelsDialogTitle = "सभी कैश किए गए मॉडल साफ़ करें?"
